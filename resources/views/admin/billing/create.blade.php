                                    ...
                                    <div class="card-body">
                                      ...
                                      <form method="post">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="name" placeholder="Name of package" class="form-control">

                                        </div>

                                        <div class="form-group">

                                          <input type="number" name="duration" placeholder="Duration in days" class="form-control">

                                        </div>  

                                        <div class="form-group">

                                            <input type="number" name="price" placeholder="Amount in Naira" class="form-control">
