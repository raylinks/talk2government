                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ADD  STATES AND THEIR RESPECTIVE CONSTITUENCIES</h4>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="all states" placeholder="all states" class="form-control">
                                            ...
                                            {{-- <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                                 @foreach ($states as $sta)
                                                     ...
                                                     <li><a href="#{{$sta->id}}" data-toggle="tab" >{{$sta->name}}</a></li>
                                                 @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="duration" placeholder="local govt" class="form-control">
                                           {{-- <div id="my-tab-content" class="tab-content">
                                                @foreach($states as $sta)
                                                    <div class="tab-pane " id="{{$sta->id}}">
                                                    @foreach($sta->lcda as $lcd)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" placeholder="senatorial district" class="form-control">

                                        </div>
                                        <div class="form-group">

                                            <input type="number" name="price" placeholder="constituency" class="form-control">
