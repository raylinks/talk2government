                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-toolbar">
                                            <ul>
                                                <li>
                                                    <a class="btn btn-primary" href="/admin/billing/create">
                                                        Create Billing
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <table class="table table-lg">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="text-dark text-semibold">Duration(days)</td>
                                                    <td class="text-dark text-semibold">Amount (NGN)</td>
                                            ...
                                            @foreach($billings as $billing)
                                                <tr>
                                                    ...
                                                    <td>{{ $billing->price }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.billing.edit', $billing->id) }}" class="btn btn-xs btn-success"> <i class="fa fa-pencil"></i> Edit</a>
                                                        <a href="{{ route('admin.billing.delete', $billing->id) }}" class="btn btn-xs btn-danger"> <i class="fa fa-trash"></i> Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
