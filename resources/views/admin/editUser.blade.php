                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="lastname" value="{{$user->userDetail->lastname}}" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="firstname" value="{{$user->userDetail->firstname}}" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" name="middlename" value="{{$user->userDetail->middlename}}" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <input type="email" name="email" value="{{$user->userDetail->email}}" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" name="sub_code" value="{{$user->userDetail->sub_code}}" placeholder="Enter sub account code here"  class="form-control">
                                        </div>
