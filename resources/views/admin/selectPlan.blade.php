                            ...
                            <div class="card">
                                ...
                                <form method="post">
                                    ...
                                    <div class="table-overflow">
                                        firstname:  {{$user->userDetail->firstname}}<br>
                                        lastname:  {{$user->userDetail->lastname}}<br>
                                        email:  {{$user->userDetail->email}}<br>
                                        <br><br>
                                        <select name="plan">
                                            @foreach($billings as $billing)
                                                <option value="{{$billing->id}}">{{$billing->name}} - {{$billing->duration}} (days)</option>
                                            @endforeach
                                        </select>
                                        <br><br>
